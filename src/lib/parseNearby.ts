...
export const COMMUNITY_COORDS: Record<string, [number, number]> = {
  ...
  // Geocoded via Nominatim (the same source this file already uses) and
  // validated three ways: inside a UAE bounding box, address.country_code ae,
  // and the returned feature must be place-like (suburb/neighbourhood/island/
  // residential) with a name sharing a distinctive token with the query.
  // That last check matters — the first hit for "Dubailand" is a sales office
  // several km from the district, and "Dubai Islands" resolves to "Bur Dubai"
  // unless the name is verified. Dubailand itself is deliberately absent: at
  ...
  "arjan":                     [25.0603, 55.2355],
  "dubai production city":     [25.0321, 55.1913],
  "damac hills 2":             [24.9876, 55.3868],
  "dubai maritime city":       [25.2496, 55.2762],
  "dubai silicon oasis":       [25.1217, 55.3855],
  "al satwa":                  [25.2209, 55.2738],
  "sobha hartland":            [25.1774, 55.308],
  "jebel ali village":         [25.0302, 55.1127],
  "emaar beachfront":          [25.097, 55.1382],
  "emaar south":               [24.8547, 55.1471],
  "jumeirah golf estates":     [25.0219, 55.1981],
  "motor city":                [25.0424, 55.2417],
  "nad al sheba":              [25.1456, 55.3643],
  "expo city":                 [24.9618, 55.1593],
  "the valley":                [24.9999, 55.4306],
  "mina rashid":               [25.2711, 55.2659],
  "wasl gate":                 [25.0258, 55.1076],
  "city walk":                 [25.2054, 55.2635],
  "sobha hartland 2":          [25.1774, 55.308],
  "dubai studio city":         [25.0416, 55.2523],
  "downtown jebel ali":        [24.9545, 55.0778],
  "al barari":                 [25.1083, 55.3188],
  "city of arabia":            [25.089, 55.3374],
  "za'abeel":                  [25.2168, 55.3001],
  "jumeirah bay island":       [25.2155, 55.2362],
  "jumeirah park":             [25.0469, 55.1548],
  "liwan":                     [25.1101, 55.3677],
  "dubai industrial city":     [24.8399, 55.0663],
  "al sufouh":                 [25.1095, 55.1722],
  "jbr":                       [25.0778, 55.1352],
  "arabian ranches 2":         [25.0348, 55.2719],
  "al wasl":                   [25.1959, 55.2557],
  "dubai internet city":       [25.0952, 55.1598],
  "warsan 4":                  [25.1404, 55.4114],
  "the valley,":               [24.9999, 55.4306],
  "dubai design district":     [25.1883, 55.2975],
  "barsha heights":            [25.0983, 55.1758],
  "port rashid":               [25.2711, 55.2659],
  "reem":                      [25.0316, 55.2757],
  "dubai media city":          [25.0935, 55.1516],
  "dubai harbour":             [25.0956, 55.1382],
  "wadi al safa":              [25.0825, 55.3408],
  "falcon city":               [25.0996, 55.3394],
  "muhaisnah":                 [25.2607, 55.4197],
  "emirates hills":            [25.064, 55.1646],
  "dubai land":                [25.0777, 55.3661],
  "wadi al safa 2":            [25.0999, 55.352],
  "warsan 1,":                 [25.1655, 55.4084],
  "dubai sports city":         [25.0321, 55.2194],
  "al sufouh,":                [25.1095, 55.1722],
  "jvt,":                      [25.0449, 55.182],
  "majan,":                    [25.0929, 55.3185],
  "al hebiah 5":               [25.0063, 55.2425],
  "emaar south,":              [24.8547, 55.1471],
  "dubai industrial city,":    [24.8399, 55.0663],
  "downtown jebel ali,":       [24.9545, 55.0778],
  "liwan,":                    [25.1101, 55.3677],
  "al khawaneej":              [25.2407, 55.489],
  "al mamzar":                 [25.3005, 55.3596],
  "dubai festival city":       [25.2217, 55.3592],
  "al habtoor city":           [25.1831, 55.2558],
};
