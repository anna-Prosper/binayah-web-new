...
const LABELS: Record<Locale, {
  ...
  en: {
    ...
    trustFooter: ["17+ Years in UAE Real Estate", "2,500+ Properties", "No Commission for Buyers", "Regulated by RERA"],
  ...
  ru: {
    ...
    trustFooter: ["17+ лет на рынке недвижимости ОАЭ", "2 500+ объектов", "Без комиссии для покупателей", "Лицензировано RERA"],
  ...
  ar: {
    ...
    trustFooter: ["أكثر من 17 عاماً في سوق العقارات الإماراتي", "2,500+ عقار", "بدون عمولة للمشترين", "مرخّص من RERA"],
  ...
  zh: {
    ...
    ctaPrimaryBtn: "免费咨询",
    trustFooter: ["深耕阿联酋房地产17年以上", "2,500+套房产", "买家零佣金", "持RERA监管牌照"],
