...
const HOME_FAQS: Record<string, { question: string; answer: string }[]> = {
  en: [
    ...
    { question: "Can I get a mortgage in Dubai as a non-resident?", answer: "Yes. UAE banks offer mortgages to non-residents for ready properties. Under UAE Central Bank caps, non-residents can borrow up to 50% loan-to-value on a first property, versus up to 80% for UAE residents, and higher-value or off-plan purchases attract lower caps. Minimum property value for a non-resident mortgage is usually AED 1,000,000. Some developers also offer 0% interest developer financing on off-plan projects." },
    { question: "What is the DLD transfer fee in Dubai?", answer: "The Dubai Land Department (DLD) charges a 4% transfer fee on the property value. It is customarily paid in full by the buyer, though who pays is negotiable and should be recorded in Form F. There is also a DLD admin fee of AED 580, a trustee fee of AED 4,000 (for properties over AED 500K), and a title deed issuance fee of AED 540." },
  ],
  fr: [
    { question: "Les étrangers peuvent-ils acheter un bien immobilier à Dubaï ?", answer: "Oui. Les Émirats arabes unis autorisent la pleine propriété à 100 % pour toutes les nationalités dans les zones franches désignées, notamment Dubai Marina, Downtown Dubaï, Palm Jumeirah, Business Bay, JVC et plus de 60 autres communautés. Aucune résidence n'est requise." },
    { question: "Quel est l'investissement minimum pour acheter un bien à Dubaï ?", answer: "Les studios débutent à partir de 300 000-500 000 AED (~82 000-136 000 $). Les projets sur plan exigent généralement un acompte de 10 à 20 % avec des plans de paiement flexibles après la remise des clés. Pour le Golden Visa des Émirats de 10 ans, le minimum est de 2 000 000 AED (~545 000 $)." },
    { question: "Existe-t-il des impôts fonciers à Dubaï ?", answer: "Non. Dubaï n'applique aucun impôt foncier annuel, aucun impôt sur les plus-values, aucun impôt sur le revenu et aucun droit de succession. Les seuls coûts ponctuels sont les frais de transfert DLD (4 %) et la commission de l'agent (~2 %). Cela fait de Dubaï l'un des marchés immobiliers les plus avantageux fiscalement au monde." },
    { question: "Qu'est-ce qu'un bien sur plan à Dubaï ?", answer: "Sur plan signifie acheter un bien avant sa construction ou pendant celle-ci. Les acheteurs versent généralement 10 à 20 % à l'avance, le solde étant dû par échéances durant la construction ou après la remise des clés. Les biens sur plan à Dubaï sont souvent 15 à 30 % moins chers que des unités livrées comparables et offrent une forte valorisation du capital." },
    { question: "Quelles sont les meilleures zones où investir à Dubaï ?", answer: "Pour le rendement locatif : Jumeirah Village Circle (JVC), Dubai Marina et Business Bay offrent des rendements bruts de 6 à 9 %. Pour la valorisation du capital : Downtown Dubaï, Palm Jumeirah et Dubai Creek Harbour. Pour le sur plan : Dubai South, Meydan et Ras Al Khor sont des zones émergentes à forte croissance." },
    { question: "Combien de temps prend le processus d'achat immobilier à Dubaï ?", answer: "Sur plan : 2 à 4 semaines de la réservation à la confirmation. Marché prêt/secondaire : 4 à 8 semaines du prix convenu au titre de propriété DLD. Le transfert DLD lui-même prend 1 à 2 jours ouvrables une fois tous les documents prêts et le crédit (le cas échéant) approuvé." },
    { question: "Puis-je obtenir un crédit immobilier à Dubaï en tant que non-résident ?", answer: "Oui. Les banques des Émirats accordent des crédits aux non-résidents pour les biens livrés. Selon les plafonds de la Banque centrale des EAU, les non-résidents peuvent emprunter jusqu'à 50 % de la valeur du bien (LTV) pour une première acquisition, contre jusqu'à 80 % pour les résidents, et les biens de valeur élevée ou les achats sur plan sont soumis à des plafonds plus bas. La valeur minimale du bien pour un crédit non-résident est généralement de 1 000 000 AED. Certains promoteurs proposent aussi un financement à 0 % d'intérêt sur les projets sur plan." },
    { question: "Quels sont les frais de transfert DLD à Dubaï ?", answer: "Le Dubai Land Department (DLD) applique des frais de transfert de 4 % sur la valeur du bien. Ils sont, dans la grande majorité des transactions, payés intégralement par l'acheteur, même si la répartition est négociable et doit être consignée dans le Form F. S'y ajoutent des frais administratifs DLD de 580 AED, des frais de mandataire de 4 000 AED (pour les biens de plus de 500 000 AED) et des frais d'émission du titre de propriété de 540 AED." },
  ],
  ru: [
    ...
    { question: "Можно ли получить ипотеку в Дубае, не являясь резидентом?", answer: "Да. Банки ОАЭ выдают ипотеку нерезидентам на готовые объекты. По правилам Центрального банка ОАЭ нерезидент может занять до 50% стоимости объекта (LTV) при покупке первого жилья, тогда как резидент, до 80%; для дорогих объектов и новостроек лимиты ниже. Некоторые застройщики предлагают беспроцентную рассрочку на новостройки." },
    { question: "Что такое сбор DLD и сколько он составляет?", answer: "Земельный департамент Дубая (DLD) взимает сбор в размере 4% от стоимости объекта при переходе права собственности. В подавляющем большинстве сделок его полностью оплачивает покупатель, хотя распределение оговаривается сторонами и фиксируется в Form F. Отдельно оплачивается выдача свидетельства о собственности, 540 AED." },
  ],
  ar: [
    ...
    { question: "هل يمكن الحصول على قرض عقاري في دبي كغير مقيم؟", answer: "نعم. تُقدّم بنوك الإمارات قروضًا عقارية لغير المقيمين للعقارات الجاهزة. ووفق سقوف المصرف المركزي الإماراتي، يمكن لغير المقيم الاقتراض بنسبة تمويل تصل إلى 50% من قيمة العقار الأول، مقابل ما يصل إلى 80% للمقيمين، مع سقوف أقل للعقارات مرتفعة القيمة والمشاريع على الخارطة. يُتيح بعض المطوّرين خططَ تقسيط بدون فوائد للمشاريع على الخارطة." },
    { question: "ما رسوم DLD وكم تبلغ؟", answer: "تفرض دائرة الأراضي والأملاك رسومًا بنسبة 4% من قيمة العقار عند نقل الملكية، ويدفعها المشتري بالكامل في الغالبية العظمى من الصفقات، مع أن تحديد الطرف الدافع قابل للتفاوض ويُدوَّن في النموذج F. وتُضاف رسوم إصدار سند الملكية البالغة 540 درهمًا." },
  ],
  zh: [
    ...
    { question: "非居民可以在迪拜申请贷款吗？", answer: "可以。阿联酋银行为非居民提供现房贷款，根据阿联酋央行的上限规定，非居民购买首套房最高可贷房产价值的50%（LTV），居民最高80%；高价房产和期房的上限更低。部分开发商还为期房提供0利率开发商融资计划。" },
    { question: "DLD过户费是多少？", answer: "迪拜土地局（DLD）收取房产价值4%的过户费，在绝大多数交易中由买方全额承担，但由谁支付可以协商，并应在Form F中写明。此外还有约580迪拉姆的行政费、4,000迪拉姆的公证费，以及540迪拉姆的产权证签发费。" },
  ],
  vi: [
    ...
    { question: "Tôi có thể vay thế chấp ở Dubai khi không phải là cư dân không?", answer: "Có. Các ngân hàng UAE cung cấp các khoản vay thế chấp cho người không cư trú đối với các bất động sản đã sẵn sàng. Theo trần của Ngân hàng Trung ương UAE, người không cư trú được vay tối đa 50% giá trị bất động sản (LTV) đối với bất động sản đầu tiên, so với tối đa 80% cho cư dân UAE; bất động sản giá trị cao và off-plan có trần thấp hơn. Giá trị bất động sản tối thiểu cho khoản vay thế chấp của người không cư trú thường là AED 1,000,000. Một số nhà phát triển cũng cung cấp tài chính phát triển không lãi suất cho các dự án chưa hoàn thành." },
    { question: "Phí chuyển nhượng DLD ở Dubai là gì?", answer: "Cục Đất đai Dubai (DLD) tính phí chuyển nhượng 4% trên giá trị bất động sản. Trong đại đa số giao dịch, người mua trả toàn bộ khoản phí này, mặc dù bên nào trả là điều có thể thương lượng và nên được ghi trong Form F. Cũng có phí hành chính DLD là AED 580, phí ủy thác là AED 4,000 (đối với bất động sản trên AED 500K), và phí cấp giấy chứng nhận quyền sở hữu là AED 540." },
  ],
  he: [
    ...
    { question: "האם אני יכול לקבל משכנתא בדובאי כלא תושב?", answer: "כן. בנקים באיחוד האמירויות מציעים משכנתאות ללא תושבים עבור נכסים מוכנים. לפי תקרות הבנק המרכזי של איחוד האמירויות, לא-תושבים יכולים ללוות עד 50% מערך הנכס (LTV) בנכס ראשון, לעומת עד 80% לתושבי איחוד האמירויות; בנכסים יקרים ובנכסים בתכנון מוקדם התקרות נמוכות יותר. ערך הנכס המינימלי למשכנתא ללא תושב הוא בדרך כלל AED 1,000,000. חלק מהיזמים מציעים גם מימון יזמי ללא ריבית על פרויקטים בתכנון מוקדם." },
    { question: "מהו דמי ההעברה ל-DLD בדובאי?", answer: "מחלקת הקרקעות של דובאי (DLD) גובה דמי העברה של 4% מערך הנכס. ברוב המכריע של העסקאות הקונה משלם אותם במלואם, אם כי ניתן לנהל משא ומתן על חלוקת התשלום ויש לציין זאת ב-Form F. יש גם דמי ניהול ל-DLD של AED 580, דמי נאמן של AED 4,000 (לנכסים מעל AED 500K), ודמי הנפקת title deed של AED 540." },
  ],
};
