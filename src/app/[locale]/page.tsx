...
const HOME_FAQS: Record<string, { question: string; answer: string }[]> = {
  ...
  fr: [
    ...
    { question: "Puis-je obtenir un crédit immobilier à Dubaï en tant que non-résident ?", answer: "Oui. Les banques des Émirats accordent des crédits aux non-résidents pour les biens livrés. Le ratio LTV typique pour les non-résidents est de 50 à 60 % (contre 75 à 80 % pour les résidents des Émirats). La valeur minimale du bien pour un crédit non-résident est généralement de 1 000 000 AED. Certains promoteurs proposent aussi un financement à 0 % d'intérêt sur les projets sur plan." },
    { question: "Quels sont les frais de transfert DLD à Dubaï ?", answer: "Le Dubai Land Department (DLD) applique des frais de transfert de 4 % sur la valeur du bien. Ils sont généralement répartis à parts égales entre l'acheteur et le vendeur (2 % chacun), bien qu'ils puissent être négociés. S'y ajoutent des frais administratifs DLD de 580 AED, des frais de mandataire de 4 000 AED (pour les biens de plus de 500 000 AED) et des frais d'émission du titre de propriété de 250 AED." },
  ],
  ru: [
