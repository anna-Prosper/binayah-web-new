...
export default async function Page({ params }: Props) {
  ...
  const breadcrumbs = [
    ...
    { name: locale === "ru" ? "Новостройки в Рас-эль-Хайме" : locale === "ar" ? "على الخارطة في رأس الخيمة" : locale === "zh" ? "Ras Al Khaimah期房" : locale === "vi" ? "Off-Plan tại Ras Al Khaimah" : locale === "he" ? "על הנייר ב-Ras Al Khaimah" : "Off-Plan in Ras Al Khaimah", href: `${lp}/off-plan/ras-al-khaimah` },
  ];
  return (
      ...
      <section className="relative overflow-hidden pt-32 pb-16 text-white" style={{ background: "linear-gradient(135deg, #0B3D2E, #1A7A5A)" }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">
            {locale === "ru" ? "Новостройки в Рас-эль-Хайме" : locale === "ar" ? "على الخارطة في رأس الخيمة" : locale === "zh" ? "Ras Al Khaimah期房项目" : locale === "vi" ? "Bất động sản Off-Plan tại Ras Al Khaimah" : locale === "he" ? "נכסים על הנייר ב-Ras Al Khaimah" : "Off-Plan Properties in Ras Al Khaimah"}
          </h1>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-10">
        ...
        <section className="bg-card border border-border/50 rounded-2xl p-8">
          <h2 className="text-xl font-bold text-foreground mb-4">
            {locale === "ru" ? "Почему инвестировать в Рас-эль-Хайму?" : locale === "ar" ? "لماذا الاستثمار في رأس الخيمة؟" : locale === "zh" ? "为什么投资RAK？" : locale === "vi" ? "Vì sao đầu tư vào Ras Al Khaimah?" : locale === "he" ? "למה להשקיע ב-Ras Al Khaimah?" : "Why Invest in Ras Al Khaimah?"}
          </h2>
