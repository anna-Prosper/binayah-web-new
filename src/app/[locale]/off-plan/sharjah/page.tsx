    ...
    <div className="min-h-screen bg-background" dir={isRtl ? "rtl" : "ltr"}>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-10">
        ...
        <section className="bg-card border border-border/50 rounded-2xl p-8">
          ...
          <p className="text-xs text-muted-foreground mb-6">{locale === "fr" ? "L'écart de prix d'environ 30 % avec Dubaï est une comparaison indicative des prix résidentiels moyens publiés pour les deux émirats ; selon le segment et la période, les estimations publiées vont d'environ 30 % à 50 %. Les prix réels varient selon le projet et l'unité." : locale === "ru" ? "Разница в цене около 30% с Дубаем, ориентировочное сравнение опубликованных средних цен на жильё в двух эмиратах; в зависимости от сегмента и периода публикуемые оценки составляют примерно от 30% до 50%. Фактические цены зависят от проекта и конкретной квартиры." : locale === "ar" ? "فارق السعر البالغ نحو 30% مقارنةً بدبي هو مقارنة استرشادية لمتوسط أسعار السكن المنشورة في الإمارتين؛ وتتراوح التقديرات المنشورة بين نحو 30% و50% بحسب الشريحة والفترة. وتختلف الأسعار الفعلية حسب المشروع والوحدة." : locale === "zh" ? "与迪拜约30%的价差为两个酋长国已公布住宅均价的参考性对比；视细分市场与时期不同，公开估算区间约为30%至50%。实际价格因项目和房型而异。" : locale === "vi" ? "Mức chênh lệch giá khoảng 30% so với Dubai là so sánh mang tính tham khảo dựa trên giá nhà ở trung bình đã công bố của hai tiểu vương quốc; tùy phân khúc và thời điểm, các ước tính công bố dao động từ khoảng 30% đến 50%. Giá thực tế thay đổi theo dự án và từng căn." : locale === "he" ? "פער המחירים של כ-30% מול דובאי הוא השוואה אינדיקטיבית של מחירי הדיור הממוצעים המפורסמים בשתי האמירויות; בהתאם לסגמנט ולתקופה, ההערכות המפורסמות נעות בין כ-30% ל-50%. המחירים בפועל משתנים לפי הפרויקט והיחידה." : "The roughly 30% price gap versus Dubai is an indicative comparison of published average residential prices in the two emirates; depending on segment and period, published estimates range from about 30% to 50%. Actual pricing varies by project and unit."}</p>
