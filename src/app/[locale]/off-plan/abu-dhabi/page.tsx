...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const desc = locale === "ru" ? "Новостройки в Абу-Даби — квартиры, виллы и таунхаусы. Aldar, Imkan, Bloom на Яс-Айленд, Саадийят, Аль-Рим Айленд." : locale === "ar" ? "مشاريع على الخارطة في أبوظبي — شقق وفلل وتاون هاوس. Aldar وImkan وBloom في جزيرة ياس وجزيرة السعديات وجزيرة الريم." : locale === "zh" ? "阿布扎比期房项目——公寓、别墅和联排。Aldar、Imkan、Bloom，位于亚斯岛、萨迪亚特岛、里姆岛。" : "Off-plan apartments, villas and townhouses in Abu Dhabi. Aldar, Imkan, Bloom on Yas Island, Saadiyat, Al Reem Island.";
  const title = locale === "ru" ? "Новостройки в Абу-Даби 2026 | Aldar, Imkan | Binayah" : locale === "ar" ? "عقارات على الخارطة في أبوظبي 2026 | Binayah" : locale === "zh" ? "阿布扎比期房2026 | Binayah" : "Off-Plan Properties in Abu Dhabi 2026 | New Projects | Binayah";
  return {
    title,
    description: desc,
