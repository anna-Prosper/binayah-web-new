...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Off-Plan Properties in Abu Dhabi 2026 | New Projects | Binayah",
    description: "Off-plan apartments, villas and townhouses in Abu Dhabi. Aldar, Imkan, Bloom on Yas Island, Saadiyat, Al Reem Island.",
    ...
    openGraph: { title: "Off-Plan Properties in Abu Dhabi 2026 | New Projects | Binayah", description: "Off-plan apartments, villas and townhouses in Abu Dhabi. Aldar, Imkan, Bloom on Yas Island, Saadiyat, Al Reem Island.", url, type: "website", locale: OG_LOCALE[locale] ?? "en_AE", images: [{ url: DEFAULT_OG_IMAGE, width: 1200, height: 630 }] },
  };
}
...
export default async function Page({ params }: Props) {
  ...
  const breadcrumbs = [
    ...
    { name: locale === "ru" ? "Новостройки в Abu Dhabi" : locale === "ar" ? "على الخارطة في Abu Dhabi" : locale === "zh" ? "Abu Dhabi期房" : "Off-Plan in Abu Dhabi", href: `${lp}/off-plan/abu-dhabi` },
  ];
  return (
      ...
      <section className="relative overflow-hidden pt-32 pb-16 text-white" style={{ background: "linear-gradient(135deg, #0B3D2E, #1A7A5A)" }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">
            {locale === "ru" ? "Новостройки в Abu Dhabi" : locale === "ar" ? "على الخارطة في Abu Dhabi" : locale === "zh" ? "Abu Dhabi期房项目" : "Off-Plan Properties in Abu Dhabi"}
          </h1>
          <p className="text-primary-foreground/80 text-lg max-w-2xl mb-8">Off-plan apartments, villas and townhouses in Abu Dhabi. Aldar, Imkan, Bloom on Yas Island, Saadiyat, Al Reem Island.</p>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-10">
        ...
        <section className="bg-card border border-border/50 rounded-2xl p-8">
          <h2 className="text-xl font-bold text-foreground mb-4">
            {locale === "ru" ? "Почему инвестировать в Abu Dhabi?" : locale === "ar" ? "لماذا الاستثمار في Abu Dhabi؟" : locale === "zh" ? "为什么投资Abu Dhabi？" : "Why Invest in Abu Dhabi?"}
          </h2>
          <p className="text-muted-foreground mb-6">Off-plan apartments, villas and townhouses in Abu Dhabi. Aldar, Imkan, Bloom on Yas Island, Saadiyat, Al Reem Island.</p>
