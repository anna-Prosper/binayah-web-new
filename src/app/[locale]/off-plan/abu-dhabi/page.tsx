...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const desc = locale === "ru" ? "Новостройки в Абу-Даби — квартиры, виллы и таунхаусы. Aldar, Imkan, Bloom на Яс-Айленд, Саадийят, Аль-Рим Айленд." : locale === "ar" ? "مشاريع على الخارطة في أبوظبي — شقق وفلل وتاون هاوس. Aldar وImkan وBloom في جزيرة ياس وجزيرة السعديات وجزيرة الريم." : locale === "zh" ? "阿布扎比期房项目——公寓、别墅和联排。Aldar、Imkan、Bloom，位于亚斯岛、萨迪亚特岛、里姆岛。" : locale === "vi" ? "Căn hộ, biệt thự và nhà phố off-plan tại Abu Dhabi. Aldar, Imkan, Bloom trên Yas Island, Saadiyat, Al Reem Island." : "Off-plan apartments, villas and townhouses in Abu Dhabi. Aldar, Imkan, Bloom on Yas Island, Saadiyat, Al Reem Island.";
  const title = locale === "ru" ? "Новостройки в Абу-Даби 2026 | Aldar, Imkan | Binayah" : locale === "ar" ? "عقارات على الخارطة في أبوظبي 2026 | Binayah" : locale === "zh" ? "阿布扎比期房2026 | Binayah" : locale === "vi" ? "Bất động sản Off-Plan tại Abu Dhabi 2026 | Aldar, Imkan | Binayah" : "Off-Plan Properties in Abu Dhabi 2026 | New Projects | Binayah";
  return {
    title,
    description: desc,
...
export default async function Page({ params }: Props) {
  ...
  const breadcrumbs = [
    ...
    { name: locale === "ru" ? "Новостройки в Abu Dhabi" : locale === "ar" ? "على الخارطة في Abu Dhabi" : locale === "zh" ? "Abu Dhabi期房" : locale === "vi" ? "Off-Plan tại Abu Dhabi" : "Off-Plan in Abu Dhabi", href: `${lp}/off-plan/abu-dhabi` },
  ];
  return (
    <div className="min-h-screen bg-background" dir={isRtl ? "rtl" : "ltr"}>
      <FAQJsonLd faqs={[{ question: "Is Abu Dhabi off-plan property a good investment?", answer: "Yes. Abu Dhabi offers a growing real estate market with strong government backing, quality developers, and competitive entry prices compared to Dubai. Contact Binayah for a detailed market briefing." }]} />
      ...
      <section className="relative overflow-hidden pt-32 pb-16 text-white" style={{ background: "linear-gradient(135deg, #0B3D2E, #1A7A5A)" }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">
            {locale === "ru" ? "Новостройки в Abu Dhabi" : locale === "ar" ? "على الخارطة في Abu Dhabi" : locale === "zh" ? "Abu Dhabi期房项目" : locale === "vi" ? "Bất động sản Off-Plan tại Abu Dhabi" : "Off-Plan Properties in Abu Dhabi"}
          </h1>
          <p className="text-primary-foreground/80 text-lg max-w-2xl mb-8">{locale === "ru" ? "Новостройки в Абу-Даби — квартиры, виллы и таунхаусы. Aldar, Imkan, Bloom на Яс-Айленд, Саадийят, Аль-Рим Айленд." : locale === "ar" ? "مشاريع على الخارطة في أبوظبي — شقق وفلل وتاون هاوس. Aldar وImkan وBloom في جزيرة ياس وجزيرة السعديات وجزيرة الريم." : locale === "zh" ? "阿布扎比期房项目——公寓、别墅和联排。Aldar、Imkan、Bloom，位于亚斯岛、萨迪亚特岛、里姆岛。" : locale === "vi" ? "Căn hộ, biệt thự và nhà phố off-plan tại Abu Dhabi. Aldar, Imkan, Bloom trên Yas Island, Saadiyat, Al Reem Island." : "Off-plan apartments, villas and townhouses in Abu Dhabi. Aldar, Imkan, Bloom on Yas Island, Saadiyat, Al Reem Island."}</p>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-10">
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-5">
            {locale === "ru" ? "Ключевые районы и острова" : locale === "ar" ? "المناطق الرئيسية" : locale === "zh" ? "主要区域" : locale === "vi" ? "Khu vực & Đảo chính" : "Key Areas & Islands"}
          </h2>
        ...
        <section className="bg-card border border-border/50 rounded-2xl p-8">
          <h2 className="text-xl font-bold text-foreground mb-4">
            {locale === "ru" ? "Почему инвестировать в Abu Dhabi?" : locale === "ar" ? "لماذا الاستثمار في Abu Dhabi؟" : locale === "zh" ? "为什么投资Abu Dhabi？" : locale === "vi" ? "Vì sao đầu tư vào Abu Dhabi?" : "Why Invest in Abu Dhabi?"}
          </h2>
          <p className="text-muted-foreground mb-6">{locale === "ru" ? "Новостройки в Абу-Даби — квартиры, виллы и таунхаусы. Aldar, Imkan, Bloom на Яс-Айленд, Саадийят, Аль-Рим Айленд." : locale === "ar" ? "مشاريع على الخارطة في أبوظبي — شقق وفلل وتاون هاوس. Aldar وImkan وBloom في جزيرة ياس وجزيرة السعديات وجزيرة الريم." : locale === "zh" ? "阿布扎比期房项目——公寓、别墅和联排。Aldar、Imkan、Bloom，位于亚斯岛、萨迪亚特岛、里姆岛。" : locale === "vi" ? "Căn hộ, biệt thự và nhà phố off-plan tại Abu Dhabi. Aldar, Imkan, Bloom trên Yas Island, Saadiyat, Al Reem Island." : "Off-plan apartments, villas and townhouses in Abu Dhabi. Aldar, Imkan, Bloom on Yas Island, Saadiyat, Al Reem Island."}</p>
