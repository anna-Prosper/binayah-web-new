...
export default async function Page({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-background" dir={isRtl ? "rtl" : "ltr"}>
      <FAQJsonLd faqs={[locale === "fr" ? { question: "Investir dans un bien sur plan à Abou Dabi est-il une bonne opération ?", answer: "Oui. Abou Dabi offre un marché immobilier en croissance, un fort soutien gouvernemental, des promoteurs de qualité et des prix d'entrée compétitifs par rapport à Dubaï. Contactez Binayah pour un briefing de marché détaillé." } : locale === "ru" ? { question: "Выгодно ли инвестировать в новостройки Абу-Даби?", answer: "Да. Абу-Даби предлагает растущий рынок недвижимости при сильной государственной поддержке, качественных застройщиков и конкурентные цены входа по сравнению с Дубаем. Свяжитесь с Binayah для детального обзора рынка." } : locale === "ar" ? { question: "هل الاستثمار في العقارات على الخارطة في أبوظبي فكرة جيدة؟", answer: "نعم. توفّر أبوظبي سوقًا عقاريًا متناميًا بدعم حكومي قوي ومطوّرين ذوي جودة وأسعار دخول تنافسية مقارنةً بدبي. تواصل مع بناية للحصول على إحاطة تفصيلية عن السوق." } : locale === "zh" ? { question: "投资阿布扎比期房是明智之选吗？", answer: "是的。阿布扎比拥有不断增长的房地产市场、强有力的政府支持、优质开发商，以及相比迪拜更具竞争力的入门价格。联系 Binayah 获取详细的市场简报。" } : locale === "vi" ? { question: "Bất động sản off-plan tại Abu Dhabi có phải khoản đầu tư tốt không?", answer: "Có. Abu Dhabi mang đến thị trường bất động sản đang phát triển với sự hậu thuẫn mạnh mẽ từ chính phủ, các chủ đầu tư chất lượng và mức giá vào hấp dẫn so với Dubai. Liên hệ Binayah để nhận bản tóm tắt thị trường chi tiết." } : locale === "he" ? { question: "האם השקעה בנכס על הנייר באבו דאבי היא השקעה טובה?", answer: 'כן. אבו דאבי מציעה שוק נדל"ן צומח עם גיבוי ממשלתי חזק, יזמים איכותיים ומחירי כניסה תחרותיים בהשוואה לדובאי. צרו קשר עם Binayah לתדריך שוק מפורט.' } : { question: "Is Abu Dhabi off-plan property a good investment?", answer: "Yes. Abu Dhabi offers a growing real estate market with strong government backing, quality developers, and competitive entry prices compared to Dubai. Contact Binayah for a detailed market briefing." }]} />
