...
const CONTENT = {
  ...
  he: {
    ...
    "howSubtitle": "תהליך מוכח בן 5 שלבים מהערכת השווי ועד להעברת שטר הבעלות",
    "steps": [
      {
        "n": "01",
        "title": "הערכת שוק חינם",
        "body": "הסוכנים שלנו מעריכים את הנכס שלכם באמצעות נתוני עסקאות חיים של DLD, עסקאות דומות בבניין שלכם ותנאי השוק הנוכחיים כדי לקבוע את מחיר ההצעה הנכון."
      },
      {
        "n": "02",
        "title": "שיווק מקצועי",
        "body": "אנו יוצרים רישום מקצועי עם צילום HDR, תוכנית קומה ותיאור מפורט. הנכס שלכם מתפרסם ב-Bayut, Propertyfinder, Dubizzle ו-Binayah.ae בו-זמנית."
      },
      {
        "n": "03",
        "title": "סינון קונים",
      ...
      },
      {
        ...
        "body": "אנו מנהלים את כל ההצעות ומנהלים משא ומתן בשמכם כדי להבטיח את המחיר הטוב ביותר. אתם מאשרים את התנאים הסופיים לפני חתימת כל מסמך."
      },
      {
        "n": "05",
        "title": "העברה והשלמה ב-DLD",
        "body": "אנו מתאמים עם סוכן הקונה, הבנק (במקרה של משכנתה) ועם מחלקת הקרקעות של דובאי (DLD) כדי להבטיח העברת בעלות חלקה ותקינה משפטית."
      }
    ],
    "whyTitle": "למה למכור עם Binayah",
    "whyPoints": [
      {
        "title": "צוות מוסמך RERA",
        "body": "כל סוכן של Binayah מורשה על ידי הרשות לפיקוח על הנדל\"ן (RERA). אתם מוגנים על פי חוק דובאי בכל שלב."
      },
      {
      ...
      },
      {
        ...
        "body": "מתפרסם ב-Bayut, Propertyfinder, Dubizzle ו-Binayah.ae עם צילום מקצועי. חשיפה מרבית לקונים מתאימים."
      },
      {
      ...
      },
      {
        ...
        "body": "עם משרדים המשרתים קונים רוסים, סינים, אירופים ומדינות המפרץ, אנו מחברים את הנכס שלכם למאגר גלובלי של משקיעים ומשתמשי קצה."
      },
      {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "a": "לא. אתם יכולים למכור מרחוק על ידי מתן ייפוי כוח (POA) לסוכן שלכם או לנציג משפטי בדובאי. Binayah מטפלת באופן קבוע במוכרים בינלאומיים, כולל לקוחות רוסים, אירופים ואסיאתים המשלימים את המכירה כולה מרחוק."
      },
      {
        "q": "האם אפשר למכור נכס ממושכן בדובאי?",
        "a": "כן. התשלום של הקונה משמש לסילוק יתרת המשכנתה שלכם (תהליך המכונה 'blocking letter'), והכספים הנותרים מועברים אליכם. הסוכן שלכם ב-Binayah מתאם עם הבנק שלכם כדי להבטיח מעבר חלק."
      },
      {
        "q": "אילו מסמכים אני צריך כדי למכור נכס בדובאי?",
        "a": "צילום דרכון, שטר בעלות מקורי (או עותק שהונפק על ידי נאמן), פרטי הנכס (תוכנית קומה, דוחות דמי שירות), NOC מהיזם וטופס A חתום (הסכם רישום). במכירה מרחוק, ייפוי כוח (POA) מנוטריון מורשה באיחוד האמירויות."
      },
      {
      ...
      },
      {
        ...
        "a": "אישור היעדר התנגדות (NOC) מונפק על ידי יזם הנכס ומאשר שאין דמי שירות או תשלומים בלתי מסולקים על היחידה. ללא NOC, מחלקת הקרקעות של דובאי לא תטפל בהעברת הבעלות. הסוכן שלכם ב-Binayah מטפל בבקשת ה-NOC בשמכם."
      }
    ],
    "ctaTitle": "מוכנים למכור?",
    "ctaDesc": "קבלו הערכת שוק חינם, ללא התחייבות, מהצוות המוסמך שלנו ב-RERA. נגיד לכם בדיוק כמה שווה הנכס שלכם בשוק של היום.",
    "ctaBtn": "קבלו הערכת שווי חינם",
    "ctaSecondary": "רשמו את הנכס שלכם",
    "breadcrumb": "מכירת נכס"
  },
  en: {
