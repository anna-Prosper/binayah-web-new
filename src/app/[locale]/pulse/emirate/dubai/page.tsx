...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: canonical(locale, "/pulse/emirate/dubai"), languages: altLangs("/pulse/emirate/dubai") },
    openGraph: {
      title: TITLES[locale] || TITLES.en,
      description: DESCS[locale] || DESCS.en,
...
export default async function DubaiEmiratePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <NextIntlClientProvider messages={pickRouteMessages(await getMessages(), ["communityLeaderboard", "dubaiEmirate", "featuredInsight", "pulseEmirateNav", "pulseSentimentChip", "weeklyReport"])}>
