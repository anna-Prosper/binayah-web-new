...
const VALUATION_FAQS: Record<string, { question: string; answer: string }[]> = {
  en: [
    ...
    { question: "How often do Dubai property values change?", answer: "Dubai property values are updated in real-time based on DLD transaction registrations. Prime areas have delivered strong appreciation in recent years, though the pace varies with the market cycle. Use Binayah's Market Pulse dashboard for up-to-date monthly trends by community." },
  ...
  ru: [
    ...
    { question: "Как часто меняются цены на недвижимость в Дубае?", answer: "Данные обновляются на основе зарегистрированных в DLD сделок. В последние годы премиальные районы показывают уверенный рост, темпы которого зависят от рыночного цикла." },
    ...
    { question: "Как измеряется стоимость недвижимости в Дубае?", answer: "Стоимость недвижимости в Дубае обычно измеряется за квадратный фут (AED/кв. фут). Средние цены сильно различаются: Даунтаун Дубай и Пальма Джумейра, 2 000-5 000+ AED/кв. фут, тогда как районы вроде JVC и Dubai South, 700-1 200 AED/кв. фут." },
  ],
  ar: [
    ...
    { question: "كم مرة تتغير أسعار العقارات في دبي؟", answer: "تُحدَّث البيانات استنادًا إلى معاملات DLD المسجَّلة. شهدت المناطق الرئيسية نموًا قويًا في السنوات الأخيرة، وإن كانت الوتيرة تختلف حسب دورة السوق." },
    { question: "هل يمكنني استخدام تقييم بناية لطلب رهن عقاري؟", answer: "التقييم المجاني عبر الإنترنت من بناية مفيد لفهم السوق لكنه لا يُقبل كتقييم رسمي لأغراض الرهن العقاري. تشترط البنوك مُقيِّمًا معتمدًا من RICS أو معتمدًا لدى البنك. يمكن لوكيل بناية إحالتك إلى مُقيِّمين معتمدين." },
    { question: "كيف تُقاس قيمة العقار في دبي؟", answer: "تُقيَّم العقارات في دبي عادةً حسب القدم المربعة (درهم/قدم مربعة). تتفاوت الأسعار بشكل كبير: وسط مدينة دبي ونخلة جميرا من 2,000 إلى 5,000+ درهم/قدم مربعة، بينما تتراوح مناطق مثل JVC ودبي الجنوب بين 700 و1,200 درهم/قدم مربعة." },
  ],
  zh: [
    ...
    { question: "迪拜房产价值多久变化一次？", answer: "数据根据DLD交易登记实时更新。近年来优质地区实现了强劲增值，涨幅因市场周期而异。" },
    { question: "Binayah估价可用于贷款申请吗？", answer: "Binayah的在线估价适合了解市场行情，但不被银行接受为正式贷款估价。银行需要RICS认证评估师的报告，您的Binayah经纪人可为您推荐认可评估师。" },
    { question: "迪拜房产价值如何衡量？", answer: "迪拜房产通常按每平方英尺（AED/平方英尺）估价。价格差异显著：迪拜市中心和棕榈岛为每平方英尺2,000-5,000+迪拉姆，而JVC和迪拜南城等地区为每平方英尺700-1,200迪拉姆。" },
  ],
  vi: [
    ...
    { question: "Giá bất động sản Dubai thay đổi thường xuyên như thế nào?", answer: "Giá trị được cập nhật theo thời gian thực dựa trên các giao dịch đăng ký với DLD. Các khu vực cao cấp đã tăng trưởng mạnh trong những năm gần đây, dù tốc độ thay đổi theo từng chu kỳ thị trường. Hãy dùng bảng điều khiển Market Pulse của Binayah để xem xu hướng hàng tháng theo khu vực." },
  ...
  fr: [
    ...
    { question: "À quelle fréquence les prix de l'immobilier à Dubaï évoluent-ils ?", answer: "Les valeurs sont mises à jour en temps réel selon les enregistrements de transactions au DLD. Les zones prisées ont connu une forte appréciation ces dernières années, à un rythme variable selon les cycles du marché. Consultez le tableau de bord Market Pulse de Binayah pour les tendances mensuelles par quartier." },
  ...
  he: [
    ...
    { question: "באיזו תדירות משתנים מחירי הנדל\"ן בדובאי?", answer: "הערכים מתעדכנים בזמן אמת לפי רישומי עסקאות ב-DLD. אזורי היוקרה רשמו עלייה חזקה בשנים האחרונות, בקצב המשתנה בהתאם למחזור השוק. השתמשו בלוח Market Pulse של Binayah למגמות חודשיות לפי אזור." },
