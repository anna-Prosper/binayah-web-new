...
const CONTENT = {
  en: {
    ...
    ctaDesc: "Our crypto real estate specialists are available Monday to Saturday. Get a personalised consultation and curated property shortlist.",
  ...
  ru: {
    ...
    ctaDesc: "Специалисты по крипто-сделкам доступны с понедельника по субботу. Персональная консультация и подборка объектов.",
  ...
  vi: {
    ...
    ctaDesc: "Các chuyên gia bất động sản tiền điện tử của chúng tôi sẵn sàng từ thứ Hai đến thứ Bảy. Nhận tư vấn cá nhân hóa và danh sách bất động sản được chọn lọc.",
  ...
  he: {
    ...
    "ctaDesc": "המומחים שלנו לנדל\"ן בקריפטו זמינים בימים שני עד שבת. קבלו ייעוץ אישי ורשימת נכסים מותאמת.",
  ...
  fr: {
    ...
    ctaDesc: "Nos spécialistes de l'immobilier en crypto sont disponibles du lundi au samedi. Obtenez une consultation personnalisée et une sélection de biens sur mesure.",
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href={waHref(WA_DEFAULT_MESSAGE, "/buy-with-crypto")}
                target="_blank"
