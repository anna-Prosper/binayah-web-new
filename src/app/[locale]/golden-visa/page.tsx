...
const CONTENT = {
  he: {
    "title": "ויזת זהב לאיחוד האמירויות באמצעות השקעה בנכס | תושבות ל-10 שנים | Binayah",
    "desc": "קבלו ויזת זהב לאיחוד האמירויות ל-10 שנים על ידי השקעה של 2 מיליון AED ומעלה בנכס בדובאי. מדריך מלא: זכאות, תהליך, מסמכים והנכסים הטובים ביותר לעמידה בתנאים. ייעוץ חינם.",
    "h1": "ויזת זהב לאיחוד האמירויות",
    "h1sub": "תושבות ל-10 שנים באמצעות נכס",
    "intro": "ויזת הזהב של איחוד האמירויות מעניקה תושבות מתחדשת ל-10 שנים למשקיעי נדל\"ן הרוכשים נכס באיחוד האמירויות בשווי 2,000,000 AED (כ-545,000 דולר) ומעלה. בניגוד לוויזות בחסות מעסיק, ויזת הזהב היא בחסות עצמית, ניתנת לחידוש ללא הגבלה וכוללת בני משפחה.",
    "steps": [
      {
        "n": "01",
        "title": "רכישת נכס ב-2 מיליון AED ומעלה",
        "body": "רכשו נכס אחד או יותר באיחוד האמירויות בשווי כולל של 2,000,000 AED ומעלה. הנכס יכול להיות על הנייר (off-plan) ובלבד ששולמו לפחות 50%, או יחידה מוגמרת ומוכנה."
      },
      {
        "n": "02",
        "title": "קבלת שטר בעלות / OQOOD",
        "body": "לנכסים מוגמרים: שטר בעלות של DLD. לנכסים על הנייר: רישום OQOOD (טרום-שטר בעלות הרשום על ידי היזם). שניהם מזכים בוויזה."
      },
      {
        "n": "03",
        "title": "הגשת בקשה דרך ICA או GDRFA",
        "body": "הגישו את בקשת ויזת הזהב דרך הרשות הפדרלית לזהות, אזרחות, מכס ואבטחת נמלים (ICA) או GDRFA דובאי. Binayah מסייעת בכל תהליך הבקשה."
      },
      {
        "n": "04",
    ...
    "benefits": [
      {
        "title": "10 שנים ניתנות לחידוש",
        "body": "ויזת הזהב תקפה ל-10 שנים וניתנת לחידוש כל עוד אתם שומרים על השקעת הנכס המזכה."
      },
      {
        "title": "בחסות עצמית",
        "body": "ללא צורך במעסיק. ללא צורך בנותן חסות מקומי. הוויזה קשורה לחלוטין לבעלות שלכם על הנכס."
      },
      {
        "title": "כוללת בני משפחה",
        "body": "בן/בת זוג, ילדים (בכל גיל), הורים ועובדים במשק הבית יכולים לקבל חסות במסגרת ויזת הזהב שלכם."
      },
      {
        "title": "כניסות מרובות",
        "body": "ללא דרישת שהייה מינימלית. ניתן לגור בכל מקום ולהיכנס לאיחוד האמירויות מספר בלתי מוגבל של פעמים ללא הגבלות ויזה."
      },
      {
        "title": "חופש עסקי",
        "body": "מחזיקי ויזת זהב יכולים לפתוח חברות באיחוד האמירויות ללא שותף מקומי ביבשת (mainland) (בעלות זרה של 100% על פי החוקים החדשים)."
      },
      {
        "title": "גישה לחינוך",
        "body": "ילדיהם של מחזיקי ויזת הזהב זכאים להירשם לבתי ספר באיחוד האמירויות ויכולים ללמוד בבתי הספר הבינלאומיים המובילים בדובאי."
      }
    ],
    "faqs": [
      {
        "question": "מהי ההשקעה המינימלית לקבלת ויזת זהב לאיחוד האמירויות באמצעות נכס?",
        "answer": "2,000,000 AED (כ-545,000 דולר או 500,000 אירו). הנכס יכול להיות בדובאי, אבו דאבי או בכל אמירות אחרת. הוא יכול להיות למגורים או מסחרי. נכסים על הנייר מזכים אם שולמו ליזם לפחות 2 מיליון AED (לפחות 50% ממחיר הרכישה)."
      },
      {
        "question": "האם אפשר להשתמש בנכס משועבד במשכנתא כדי לעמוד בתנאים לוויזת הזהב?",
        "answer": "כן, אך רק חלק ההון העצמי נספר לכיוון רף 2 מיליון AED. אם הנכס שלכם שווה 3 מיליון AED אך יש לכם משכנתא פתוחה של 1.5 מיליון AED, רק 1.5 מיליון AED של הון עצמי מזכים. תזדקקו לנכס נוסף או להון נוסף כדי להגיע לרף 2 מיליון AED."
      },
      {
        "question": "האם זרים מכל הלאומים יכולים לקבל את ויזת הזהב של איחוד האמירויות?",
        "answer": "כן. ויזת הזהב של איחוד האמירויות פתוחה לכל הלאומים. אין הגבלות לפי אזרחות. רוסים, אירופים, אמריקאים, סינים וכל שאר הלאומים זכאים באותה מידה כל עוד הם עומדים ברף ההשקעה."
      },
      {
      ...
      },
      {
        ...
        "answer": "ויזת נכס רגילה (הנקראת גם ויזת משקיע) מחייבת נכס בשווי 750,000 AED ומעניקה תושבות מתחדשת לשנתיים. ויזת הזהב מחייבת 2,000,000 AED ומעניקה תושבות ל-10 שנים ללא דרישות שהייה ועם זכויות חסות מורחבות למשפחה."
      },
      {
      ...
      },
      {
        ...
        "answer": "כן. בן/בת זוגכם, ילדים (בכל הגילים, כולל ילדים בוגרים), הורים ועובדים במשק הבית יכולים להיכלל כתלויים במסגרת ויזת הזהב שלכם. כל תלוי מקבל את אותה תושבות ל-10 שנים. ילדים הנכללים כתלויים שומרים על הוויזה שלהם גם לאחר גיל 18 כל עוד הם סטודנטים במשרה מלאה."
      }
    ],
