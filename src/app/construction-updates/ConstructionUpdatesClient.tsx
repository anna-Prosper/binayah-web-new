      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="bg-gradient-to-br from-primary via-primary/95 to-primary/85 py-12 sm:py-16">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white">
              Construction <em className="font-serif font-normal text-white/90">Updates</em>
            </h1>
            <p className="mt-3 text-sm sm:text-base text-white/70 max-w-xl">
              Track the latest construction progress of Dubai&apos;s top developments &mdash; {updates.length} projects monitored.
            </p>
            ...
            <div className="flex flex-wrap gap-4 sm:gap-6 mt-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-3 text-center min-w-[100px]">
                ...
                <p className="text-[10px] sm:text-xs text-white/60">Total Projects</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-3 text-center min-w-[100px]">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-3 text-center min-w-[100px]">
                ...
                <p className="text-[10px] sm:text-xs text-white/60">In Progress</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-3 text-center min-w-[100px]">
                <p className="text-xl sm:text-2xl font-bold text-white">{Math.round(avgProgress)}%</p>
                <p className="text-[10px] sm:text-xs text-white/60">Avg. Progress</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 sm:px-6 py-6 sm:py-8">
          ...
          <p className="text-xs text-muted-foreground mt-3">
            Showing {filtered.length} of {updates.length} projects
          </p>
        </section>
        ...
        <section className="container mx-auto px-4 sm:px-6 pb-12 sm:pb-16">
          ...
          {filtered.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-muted-foreground">No construction updates match your search.</p>
            </div>
          )}
        </section>
      </main>
