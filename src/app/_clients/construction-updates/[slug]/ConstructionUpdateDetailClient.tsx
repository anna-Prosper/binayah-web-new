...
const LABELS: Record<string, Record<string, string>> = {
  en: { back: "Project Guides", faq: "Frequently Asked Questions", viewProject: "View Project", ctaExplore: "Explore", ctaMeta: "Floor plans · Pricing · Payment plans", langs: "Available in", topics: "Topics", author: "Binayah Editorial", bookConsultation: "Book a Consultation", investmentTitle: "Get Investment Advice", investmentDesc: "Our experts are ready to guide you through this project's payment plan and ROI potential.", ctaTitle: "Ready to Invest?", ctaDesc: "Speak to our team about this project and get exclusive pricing and payment plans.", ctaWhatsApp: "Chat on WhatsApp", newsletter: "Weekly Market Report", newsletterDesc: "Get Dubai property insights every week.", subscribe: "Subscribe", subscribed: "Subscribed!", subError: "Something went wrong. Please try again.", emailPlaceholder: "your@email.com", phonePlaceholder: "+971 50 000 0000", phoneLabel: "Phone number", phoneError: "Enter a valid phone number.", home: "Home", thisProject: "This Project", authorRole: "Dubai Property Expert", authorBio: "Binayah's editorial team covers Dubai's off-plan property market with data-driven analysis and on-the-ground insights." },
  ru: { back: "Гайды по проектам", faq: "Частые вопросы", viewProject: "Смотреть проект", ctaExplore: "Смотреть", ctaMeta: "Планировки · Цены · Рассрочка", langs: "Читать на", topics: "Темы", author: "Редакция Binayah", bookConsultation: "Записаться на консультацию", investmentTitle: "Получите инвестиционный совет", investmentDesc: "Наши эксперты готовы провести вас через план оплаты и потенциал ROI этого проекта.", ctaTitle: "Готовы инвестировать?", ctaDesc: "Обратитесь к нашей команде и получите эксклюзивные цены и планы оплаты.", ctaWhatsApp: "Написать в WhatsApp", newsletter: "Еженедельный отчёт", newsletterDesc: "Получайте аналитику рынка недвижимости Дубая каждую неделю.", subscribe: "Подписаться", subscribed: "Вы подписаны!", subError: "Что-то пошло не так. Попробуйте снова.", emailPlaceholder: "your@email.com", phonePlaceholder: "+971 50 000 0000", phoneLabel: "Номер телефона", phoneError: "Введите действительный номер телефона.", home: "Главная", thisProject: "Этот проект", authorRole: "Эксперт по недвижимости Дубая", authorBio: "Редакция Binayah освещает рынок офф-план недвижимости Дубая с аналитикой на основе данных и знанием ситуации на местах." },
  ar: { back: "أدلة المشاريع", faq: "الأسئلة الشائعة", viewProject: "عرض المشروع", ctaExplore: "استكشف", ctaMeta: "المخططات · الأسعار · خطط السداد", langs: "متوفر بـ", topics: "مواضيع", author: "تحرير بنايه", bookConsultation: "احجز استشارة", investmentTitle: "احصل على نصيحة استثمارية", investmentDesc: "خبراؤنا مستعدون لإرشادك.", ctaTitle: "هل أنت مستعد للاستثمار؟", ctaDesc: "تحدث مع فريقنا للحصول على أسعار حصرية.", ctaWhatsApp: "تواصل عبر واتساب", newsletter: "تقرير أسبوعي", newsletterDesc: "احصل على رؤى سوق العقارات أسبوعياً.", subscribe: "اشترك", subscribed: "تم الاشتراك!", subError: "حدث خطأ ما. حاول مرة أخرى.", emailPlaceholder: "your@email.com", phonePlaceholder: "+971 50 000 0000", phoneLabel: "رقم الهاتف", phoneError: "يرجى إدخال رقم هاتف صحيح.", home: "الرئيسية", thisProject: "هذا المشروع", authorRole: "خبير عقارات دبي", authorBio: "يغطي فريق تحرير بناية سوق العقارات على الخارطة في دبي بتحليلات قائمة على البيانات ومعرفة ميدانية." },
  zh: { back: "项目指南", faq: "常见问题", viewProject: "查看项目", ctaExplore: "查看", ctaMeta: "户型图 · 价格 · 付款计划", langs: "可用语言", topics: "主题", author: "Binayah编辑", bookConsultation: "预约咨询", investmentTitle: "获取投资建议", investmentDesc: "我们的专家准备好指导您了解付款计划和投资回报率。", ctaTitle: "准备好投资了吗？", ctaDesc: "与我们的团队联系，获取独家定价和付款计划。", ctaWhatsApp: "WhatsApp咨询", newsletter: "每周市场报告", newsletterDesc: "每周获取迪拜房产见解。", subscribe: "订阅", subscribed: "已订阅！", subError: "出了点问题，请重试。", emailPlaceholder: "your@email.com", phonePlaceholder: "+971 50 000 0000", phoneLabel: "电话号码", phoneError: "请输入有效的电话号码。", home: "首页", thisProject: "本项目", authorRole: "迪拜房产专家", authorBio: "Binayah编辑团队以数据驱动的分析和实地洞察报道迪拜期房市场。" },
  vi: { back: "Hướng dẫn dự án", faq: "FAQ", viewProject: "Xem dự án", ctaExplore: "Khám phá", ctaMeta: "Mặt bằng · Giá · Kế hoạch thanh toán", langs: "Có sẵn bằng", topics: "Chủ đề", author: "Biên tập Binayah", bookConsultation: "Đặt lịch tư vấn", investmentTitle: "Nhận tư vấn đầu tư", investmentDesc: "Chuyên gia của chúng tôi sẵn sàng hướng dẫn bạn.", ctaTitle: "Sẵn sàng đầu tư?", ctaDesc: "Liên hệ đội ngũ của chúng tôi để nhận báo giá độc quyền.", ctaWhatsApp: "Chat trên WhatsApp", newsletter: "Báo cáo thị trường hàng tuần", newsletterDesc: "Nhận thông tin thị trường bất động sản Dubai mỗi tuần.", subscribe: "Đăng ký", subscribed: "Đã đăng ký!", subError: "Đã xảy ra lỗi. Vui lòng thử lại.", emailPlaceholder: "your@email.com", phonePlaceholder: "+971 50 000 0000", phoneLabel: "Số điện thoại", phoneError: "Vui lòng nhập số điện thoại hợp lệ.", home: "Trang chủ", thisProject: "Dự án này", authorRole: "Chuyên gia bất động sản Dubai", authorBio: "Đội ngũ biên tập của Binayah đưa tin về thị trường bất động sản off-plan Dubai với phân tích dựa trên dữ liệu và hiểu biết thực tế." },
  he: { back: "מדריכי פרויקטים", faq: "שאלות נפוצות", viewProject: "צפה בפרויקט", ctaExplore: "לגלות את", ctaMeta: "תוכניות · מחירים · תשלומים", langs: "זמין ב", topics: "נושאים", author: "מערכת Binayah", bookConsultation: "קביעת ייעוץ", investmentTitle: "קבלו ייעוץ השקעות", investmentDesc: "המומחים שלנו מוכנים ללוות אתכם בתוכנית התשלומים ובפוטנציאל התשואה של הפרויקט.", ctaTitle: "מוכנים להשקיע?", ctaDesc: "דברו עם הצוות שלנו וקבלו תמחור ותוכניות תשלום בלעדיות.", ctaWhatsApp: "שיחה ב-WhatsApp", newsletter: "דוח שוק שבועי", newsletterDesc: "קבלו תובנות נדל\"ן בדובאי מדי שבוע.", subscribe: "הרשמה", subscribed: "נרשמת!", subError: "משהו השתבש. נסו שוב.", emailPlaceholder: "your@email.com", phonePlaceholder: "+971 50 000 0000", phoneLabel: "מספר טלפון", phoneError: "יש להזין מספר טלפון תקין.", home: "דף הבית", thisProject: "הפרויקט הזה", authorRole: "מומחה נדל\"ן בדובאי", authorBio: "צוות המערכת של Binayah מסקר את שוק הנדל\"ן על הנייר בדובאי עם ניתוח מבוסס נתונים ותובנות מהשטח." },
};

function prettifyProjectName(slug?: string) {
  if (!slug) return "";
  return slug
    .split("-")
    .filter(Boolean)
                  ...
                  <ReactMarkdown
                    components={{
                      ...
                      a: ({ href, children }) => {
                        ...
                        const projectName = prettifyProjectName(article.projectSlug) || l.thisProject;
                        return (
                          <a
                            href={href}
                            className="not-prose group my-6 flex w-full items-center justify-between gap-4 rounded-xl px-6 py-4 text-accent-foreground no-underline transition-transform hover:scale-[1.01]"
                            style={{ background: "linear-gradient(135deg, #D4A847, #B8922F)", boxShadow: "0 8px 22px rgba(212,168,71,0.32)" }}
                          >
                            <span className="flex min-w-0 flex-col">
                              <span className="text-[17px] font-bold leading-tight">{l.ctaExplore} {projectName}</span>
                              <span className="mt-0.5 text-[13px] font-medium leading-tight text-accent-foreground/85">{l.ctaMeta}</span>
                            </span>
              ...
              <div className="rounded-2xl border border-border bg-card p-5">
                ...
                {subState === "done" ? (
                  ...
                  <form onSubmit={async (e) => {
                    ...
                    if (!phoneLooksValid(phone)) { setSubState("bad-phone"); return; }
                    const hp = String(fd.get("hp_check") || "");
                    setSubState("loading");
                    try {
                      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || ""}/api/market-report/subscribe`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ hp, email: String(email), phone, source: "project-article" }) });
                      setSubState(res.ok ? "done" : "error");
                    } catch { setSubState("error"); }
                  }} className="space-y-2.5">
                    <HoneypotInput />
                    <input type="tel" name="phone" required placeholder={l.phonePlaceholder} aria-label={l.phoneLabel} className="w-full px-3.5 py-2.5 rounded-xl border border-border bg-background text-sm text-foreground placeholder:text-muted-foreground/60 focus:ring-2 focus:ring-primary/20 focus:border-primary/50 outline-none transition-all" />
                    ...
                    {subState === "bad-phone" && <p className="text-xs text-red-500">{l.phoneError}</p>}
                  </form>
                )}
              </div>
            </aside>
