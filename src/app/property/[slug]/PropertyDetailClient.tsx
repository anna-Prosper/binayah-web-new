  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="sm:hidden px-4 py-3">
        <button onClick={() => setLightboxOpen(true)} className="w-full flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-[13px] font-bold text-white shadow-md active:scale-[0.97] transition-all" style={{ background: "linear-gradient(135deg, #0B3D2E, #1A7A5A)" }}>
          <ImageIcon className="h-3.5 w-3.5" />
          {t("gallery")} ({allImages.length})
        </button>
      </div>
