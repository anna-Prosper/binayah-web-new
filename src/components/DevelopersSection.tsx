        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5">
          {TOP_DEVELOPERS.map((dev, i) => (
            ...
            >
              ...
              >
                <div className="w-14 h-14 sm:w-16 sm:h-16 mb-4 rounded-xl bg-primary/[0.06] flex items-center justify-center border border-primary/10 group-hover:border-primary/25 group-hover:bg-primary/[0.10] transition-all">
