...
const WhatsAppButton = () => {
  ...
  <>
    ...
    <div className="hidden sm:block fixed bottom-24 right-6 z-40">
      ...
      {/* One-shot pop-in 2s after mount — a CSS keyframe, not a library. */}
      <a
      href={waHref(t("prefillGeneral"), pageRef)}
      target="_blank"
      rel="noopener noreferrer"
      onClick={() => { trackClick("whatsapp"); dismissPopup(); }}
      className="wa-fab-in flex w-14 h-14 bg-[#25D366] hover:bg-[#20bd5a] rounded-full items-center justify-center shadow-lg shadow-black/20 hover:shadow-xl hover:-translate-y-1 transition-all"
