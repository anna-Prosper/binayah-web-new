...
const InquirySection = () => {
  ...
  const contactItems = [
    { icon: Phone, label: "+971 55 509 9157", href: "tel:+971555099157" },
            ...
            <div className="sm:hidden space-y-4 mb-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <input required type="tel" pattern="[0-9\s()+-]{5,15}" title={t("phoneInvalid")} value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value.replace(/[^0-9\s\-()]/g, "") })} className={`${inputClasses} flex-1 min-w-0`} placeholder="50 123 4567" />
                </div>
              </div>
              <div>
