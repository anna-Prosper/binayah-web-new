    ...
    <>
      ...
      >
        <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-10">
          <div className={`flex lg:grid lg:grid-cols-[auto_1fr_auto] items-center justify-between transition-all duration-300 ${scrolled ? "h-10 sm:h-12" : "h-12 sm:h-16"}`}>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-4 pb-6 pt-2">
              ...
              <div className="pt-4 border-t border-white/10 space-y-1">
                ...
                <a href={waHref(tWa("prefillGeneral"), pathname)} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-2 py-3 text-white/80 text-sm hover:text-white transition-colors min-h-[48px]">
