      ...
      <div className="py-8 sm:py-16 grid grid-cols-2 md:grid-cols-12 gap-6 sm:gap-10">
        <div className="col-span-2 md:col-span-4">
          ...
          <div className="flex gap-2.5 sm:gap-3">
            ...
            {/* WhatsApp */}
            <a href={waHref(tWa("prefillGeneral"), pathname)} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent transition-all group">
