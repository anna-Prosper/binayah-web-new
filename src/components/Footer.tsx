    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div className="py-10 sm:py-16 grid md:grid-cols-12 gap-8 sm:gap-10">
        <div className="md:col-span-4">
          ...
          <div className="flex gap-3">
            {/* Instagram */}
            <a href="https://www.instagram.com/binayahproperties/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent transition-all group">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/binayahproperties" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent transition-all group">
            ...
            {/* YouTube */}
            <a href="https://www.youtube.com/@binayahproperties" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent transition-all group">
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/971549988811" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent transition-all group">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/company/binayah-properties" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent transition-all group">
      ...
      <div className="border-t border-white/8 py-6 pb-20 sm:pb-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6 text-xs text-white/30">
          ...
          <Link href="/design-guidelines" className="hover:text-white/60 transition-colors" title="Design Guidelines">
