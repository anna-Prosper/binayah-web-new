      ...
      <div className="py-8 sm:py-16 grid grid-cols-2 md:grid-cols-12 gap-6 sm:gap-10">
        <div className="col-span-2 md:col-span-4">
          ...
          <div className="flex gap-2.5 sm:gap-3">
            {/* Instagram */}
            <a href="https://www.instagram.com/binayahproperties/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent transition-all group">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/binayahproperties" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent transition-all group">
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/971549988811" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent transition-all group">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/company/binayah-properties" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent transition-all group">
