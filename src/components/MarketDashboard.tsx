...
const StatCard = ({ label, value }: { label: string; value: string }) => (
  <div className="bg-background rounded-lg sm:rounded-xl p-2 sm:p-5 border border-border/50 text-center sm:text-left">
    <p className="text-[8px] sm:text-xs text-muted-foreground font-medium mb-0.5 sm:mb-1 truncate">{label}</p>
    <p className="text-sm sm:text-2xl font-bold text-foreground">{value}</p>
