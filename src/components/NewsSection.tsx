        ...
        {articles.map((a, i) => (
          ...
          >
            <Link href={`/news/${a.slug}`} className="group block bg-card rounded-xl overflow-hidden border border-border/50">
              ...
              <div className="p-3">
                <p className="text-[9px] text-muted-foreground flex items-center gap-1 mb-1"><Calendar className="h-2.5 w-2.5" /> {a.date}</p>
        ...
        {articles.map((a, i) => (
          ...
          >
            <Link href={`/news/${a.slug}`} className="group block bg-card rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-border/50 hover:border-primary/20">
              ...
              <div className="p-6">
                <p className="text-xs text-muted-foreground flex items-center gap-1.5 mb-3"><Calendar className="h-3 w-3" /> {a.date}</p>
