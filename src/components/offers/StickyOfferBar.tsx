...
interface Props {
  ...
  /** False when the offer has no published end date, so there's nothing to
   *  count down to. */
 ...
 */
export default function StickyOfferBar({ title, deadline, expired = false, hideDeadline = false, showCountdown = true }: Props) {
